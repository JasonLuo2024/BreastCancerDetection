...
def subprocess_fn(rank, c, temp_dir):
    GAN.StyleGan3.dnnlib.util.Logger(file_name=os.path.join(c.run_dir, 'log.txt'), file_mode='a', should_flush=True)
...
def launch_training(c, desc, outdir, dry_run):
    GAN.StyleGan3.dnnlib.util.Logger(should_flush=True)
...
def init_dataset_kwargs(data):
    try:
        ...
        dataset_obj = GAN.StyleGan3.dnnlib.util.construct_class_by_name(**dataset_kwargs) # Subclass of training.dataset.Dataset.
...
outdir = r'/gpfs/home/hluo/GAN/result/negative'
dataset = r'/home/hluo/GAN/Vindir_Negative.zip'
num_gpus = 4  #for most users, it should be set to 1 as default
batch_size = 16 #based on your memory, if your gpu memory is 32G, for example, with 512X512 iamges, you can set it up to 16
...
pretrain_pickle = '/gpfs/home/hluo/GAN/stylegan3/network-snapshot-001200.pkl'  # not used
@click.command()
